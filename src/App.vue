    ...
    <div v-if="showAboutPanel" class="settings-modal-backdrop">
      <section class="settings-modal about-modal">
        ...
        <div class="about-brand">
          <div><strong>Riichi Mahjong Studio</strong></div>
        </div>
        <div class="about-grid">
          ...
          <div class="about-item about-links">
            <span class="about-label">使用的开源项目</span>
          ...
          <div class="about-item about-links">
            <span class="about-label">项目作者</span>
            <div class="about-link-list">
              <a href="https://github.com/SiyeW" @click.prevent="openExternalLink('https://github.com/SiyeW')">https://github.com/SiyeW</a>
            </div>
          </div>
        </div>
      </section>
