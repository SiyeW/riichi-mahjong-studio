...
from . import game_tree_coordinator
from . import gameplay_commands
from . import legal_action_provider
from . import legal_actions
from . import opponent_analysis_session
from . import play_prefetch_session
from . import reaction_decision_history
from . import record_commands
from . import record_workspace_commands
from . import record_session
from . import review_session
from . import round_actions
...
from . import wall_reconstruction
...
SERVICE_RUNTIME = ServiceRuntime(emit=emit, now_iso=now_iso)
...
ENGINE_MANAGEMENT = engine_management.EngineManagement(
    ...
    prewarm_executor=SERVICE_RUNTIME.engine_prewarm,
    emit=emit,
...
def _prewarm_record_action_engine(seat):
    SERVICE_RUNTIME.background.submit(
...
SERVICE_RUNTIME.add_shutdown(ENGINE_RUNTIME_REGISTRY.shutdown)
SERVICE_RUNTIME.add_shutdown(OPPONENT_PREDICTIONS.shutdown)
SERVICE_RUNTIME.add_shutdown(ACTION_RECOMMENDATIONS.shutdown)
...
def main():
    SERVICE_RUNTIME.run(
        ...
        process=COMMAND_TRANSPORT.process,
    )
