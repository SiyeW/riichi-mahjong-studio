...
from rms_backend import game_flow
from rms_backend import game_setup
from rms_backend import match_progression
from rms_backend import rule_kernel
...
class MatchEndRuleTests(unittest.TestCase):
    ...
    def test_negative_score_ends_match_before_all_last(self):
        match_state = game_setup.create_match_state(123456, "match_test")
