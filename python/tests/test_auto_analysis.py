...
from rms_backend import analysis_cache
from rms_backend import auto_analysis_plan
from rms_backend import engine_configuration
from rms_backend import service
from rms_backend.auto_analysis_runtime import AutoAnalysisRuntime
    ...
    def test_packaged_config_uses_user_engine_selection(self):
        with tempfile.TemporaryDirectory() as directory:
            ...
            with (
                ...
                mock.patch.object(service.sys, "executable", str(backend_root / "rms-backend.exe")),
                mock.patch.object(
                    service.ENGINE_MANAGEMENT,
                    "portable_root",
                    portable_root,
